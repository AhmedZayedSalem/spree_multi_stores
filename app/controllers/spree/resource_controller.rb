class Spree::ResourceController < Spree::BaseController
  ...
  def destroy
    ...
    if @object.destroy
      ...
      respond_with(@object) do |format|
        ...
        format.js   { render :partial => "spree/shared/destroy" }
      end
    else
  ...
  def resource
    ...
    @resource = Spree::Resource.new controller_path, controller_name, parent_model_name, object_name
  end
  ...
  def edit_object_url(object, options = {})
    if parent_data.present?
      spree.send "edit_#{resource.model_name}_#{resource.object_name}_url",
                 parent, object, options
    else
      spree.send "edit_#{resource.object_name}_url", object, options
    end
  end
  ...
  def object_url(object = nil, options = {})
    ...
    if parent_data.present?
      spree.send "#{resource.model_name}_#{resource.object_name}_url", parent, target, options
    else
      spree.send "#{resource.object_name}_url", target, options
    end
  end
